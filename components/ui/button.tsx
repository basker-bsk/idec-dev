...
const buttonVariants = cva(
  "ease-in-out duration-1000 flex gap-2 items-center lg:text-14 text-12 justify-center whitespace-nowrap rounded-md lg:rounded-lg  font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-ring focus-visible:ring-offset-0",
  {
    variants: {
      theme: {
        ...
        tertiary:
          "bg-white text-black border border-gray-500  hover:bg-black hover:text-white",
